...
class trainer():
    def __init__(self, scaler, in_dim, seq_length, num_nodes, nhid, dropout, topk, normalization, lrate, wdecay, device, days=288,
                 dims=40, order=2):
        self.model = STPGNN(device, num_nodes, dropout, topk, out_dim=seq_length, residual_channels=nhid,
